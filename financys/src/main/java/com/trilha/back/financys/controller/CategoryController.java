...
public class CategoryController {
    ...
    @PostMapping
    public ResponseEntity<Category> create(@RequestBody @Valid CategoryDto body){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Category> update(@PathVariable Long id,@RequestBody @Valid CategoryDto body){
